...
public class Tech extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tech);String[] news = {"news1 title", "news2 title", "news3 title", "news4 title", "news5 title","news1 title", "news2 title", "news3 title", "news4 title", "news5 title"};
